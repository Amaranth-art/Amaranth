...
const testimonials = [
  {
    ...
    date: "2024-10",
    content: {
      zh: "在小猫学习的30天是我人生的转折点。从完全不懂交易到通过考核，整个过程非常系统和专业。现在我每个月都能稳定盈利，真正实现了财务自由。",
  ...
  },
  {
    ...
    date: "2024-09",
    content: {
      zh: "之前在其他平台学了很久都没有成果，来到小猫后才发现什么是真正的交易培训。规则清晰，考核标准明确，老师耐心指导。通过考核后拿到资金，现在已经盈利20%+。",
  ...
  },
  {
    ...
    date: "2024-08",
    content: {
      zh: "小猫最大的优势是实战性强。不是教你理论，而是直接教你怎么在市场上赚钱。我用了25个工作日通过考核，现在管理着6位数的资金，分成比例高达80%。",
  ...
  },
  {
    ...
    date: "2024-07",
    content: {
      zh: "作为一个90后，我在小猫找到了真正适合自己的职业。30天的培训虽然辛苦，但收获巨大。现在我可以在世界任何地方工作，时间和地点完全自由。",
  ...
  },
  {
    ...
    date: "2024-06",
    content: {
      zh: "小猫的筛选机制很严格，但正因如此，通过的人都是真正有潜力的。我很庆幸自己坚持下来了。现在回头看，那45天的投入是我做过最值得的决定。",
  ...
  },
  {
    ...
    date: "2024-05",
    content: {
      zh: "我是从传统金融行业转行过来的。在小猫学到的实战技能比我在银行5年学到的还多。这里没有废话，只有干货和结果导向的培训。",
  ...
  },
  {
    ...
    date: "2024-03",
    content: {
      zh: "小猫给了我第二次职业生涯的机会。之前在互联网公司996，现在做交易时间自由，收入还翻倍了。最重要的是找到了真正热爱的事业。",
  ...
  },
  {
    ...
    date: "2024-01",
    content: {
      zh: "从面试到培训到考核，每个环节都能看出小猫的专业性。这不是培训班，而是真正的交易员孵化器。我用20个工作日通过考核，现在每月稳定盈利。",
